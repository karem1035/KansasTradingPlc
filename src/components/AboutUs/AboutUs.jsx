...
const AboutUs = () => {
    return <>
        <div id="aboutus" className="py-10 sm:min-h-[600px] sm:grid sm:place-items-center dark:bg-gray-950 dark:text-white duration-200">
            <div className="container w-full">
                {/* Header Section */}
                <div className="shadow-lg text-center dark:bg-gray-900 dark:text-white duration-200">
                    <h1 className="text-4xl sm:text-5xl lg:text-6xl max-w-full font-bold dark:text-white">About <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Us</span></h1>
                </div>
                {/* card section */}
